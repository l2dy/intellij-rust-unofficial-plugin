...
use ra_ap_proc_macro_api::legacy_protocol::{
...
use ra_ap_proc_macro_srv::{EnvSnapshot, ProcMacroKind, ProcMacroSrv};
use ra_ap_tt as tt;

pub(crate) fn run() -> io::Result<()> {
    fn macro_kind_to_api(kind: ProcMacroKind) -> ra_ap_proc_macro_api::ProcMacroKind {
        match kind {
            ProcMacroKind::CustomDerive => {
                ra_ap_proc_macro_api::ProcMacroKind::CustomDerive
            }
            ProcMacroKind::Bang => ra_ap_proc_macro_api::ProcMacroKind::Bang,
            ProcMacroKind::Attr => ra_ap_proc_macro_api::ProcMacroKind::Attr,
        }
    }
