...
val CLIPPY_LINTS: List<Lint> = listOf(
    ...
    Lint("blocks_in_conditions", false),
    ...
    Lint("cfg_not_test", false),
    Lint("char_indices_as_byte_indices", false),
    ...
    Lint("cloned_ref_to_slice_refs", false),
    Lint("cmp_null", false),
    Lint("cmp_owned", false),
    Lint("coerce_container_to_any", false),
    ...
    Lint("confusing_method_to_numeric_cast", false),
    Lint("const_is_empty", false),
    ...
    Lint("decimal_bitwise_operands", false),
    ...
    Lint("deprecated_clippy_cfg_attr", false),
    ...
    Lint("doc_broken_link", false),
    Lint("doc_comment_double_space_linebreaks", false),
    Lint("doc_include_without_cfg", false),
    Lint("doc_lazy_continuation", false),
    Lint("doc_link_code", false),
    Lint("doc_link_with_quotes", false),
    Lint("doc_markdown", false),
    Lint("doc_nested_refdefs", false),
    Lint("doc_overindented_list_items", false),
    Lint("doc_paragraphs_missing_punctuation", false),
    Lint("doc_suspicious_footnotes", false),
    Lint("double_comparisons", false),
    Lint("double_ended_iterator_last", false),
    ...
    Lint("duplicated_attributes", false),
    Lint("duration_suboptimal_units", false),
    Lint("duration_subsec", false),
    Lint("eager_transmute", false),
    Lint("elidable_lifetime_names", false),
    Lint("else_if_without_else", false),
    Lint("empty_docs", false),
    Lint("empty_drop", false),
    Lint("empty_enum_variants_with_brackets", false),
    Lint("empty_enums", false),
    ...
    Lint("field_scoped_visibility_modifiers", false),
    ...
    Lint("ignore_without_reason", false),
    Lint("ignored_unit_patterns", false),
    Lint("impl_hash_borrow_with_str_and_bytes", false),
    ...
    Lint("implied_bounds_in_impls", false),
    Lint("impossible_comparisons", false),
    Lint("imprecise_flops", false),
    Lint("incompatible_msrv", false),
    ...
    Lint("integer_division_remainder_used", false),
    Lint("into_iter_on_ref", false),
    Lint("into_iter_without_iter", false),
    ...
    Lint("io_other_error", false),
    Lint("ip_constant", false),
    ...
    Lint("iter_filter_is_ok", false),
    Lint("iter_filter_is_some", false),
    ...
    Lint("legacy_numeric_constants", false),
    ...
    Lint("lint_groups_priority", false),
    Lint("literal_string_with_formatting_args", false),
    Lint("little_endian_bytes", false),
    Lint("lossy_float_literal", false),
    Lint("macro_metavars_in_unsafe", false),
    Lint("macro_use_imports", false),
    Lint("main_recursion", false),
    Lint("manual_abs_diff", false),
    Lint("manual_assert", false),
    Lint("manual_async_fn", false),
    Lint("manual_bits", false),
    Lint("manual_c_str_literals", false),
    Lint("manual_checked_ops", false),
    Lint("manual_clamp", false),
    Lint("manual_contains", false),
    Lint("manual_dangling_ptr", false),
    Lint("manual_div_ceil", false),
    ...
    Lint("manual_hash_one", false),
    Lint("manual_ignore_case_cmp", false),
    Lint("manual_ilog2", false),
    Lint("manual_inspect", false),
    ...
    Lint("map_with_unused_argument_over_ranges", false),
    ...
    Lint("mem_replace_option_with_some", false),
    ...
    Lint("missing_asserts_for_indexing", false),
    Lint("missing_const_for_fn", false),
    Lint("missing_const_for_thread_local", false),
    ...
    Lint("missing_transmute_annotations", false),
    Lint("mistyped_literal_suffixes", false),
    Lint("mixed_attributes_style", false),
    ...
    Lint("multiple_bound_locations", false),
    ...
    Lint("needless_borrows_for_generic_args", false),
    Lint("needless_character_iteration", false),
    ...
    Lint("non_canonical_clone_impl", false),
    Lint("non_canonical_partial_ord_impl", false),
    Lint("non_minimal_cfg", false),
    Lint("non_octal_unix_permissions", false),
    Lint("non_send_fields_in_send_ty", false),
    Lint("non_std_lazy_statics", false),
    Lint("non_zero_suggestions", false),
    ...
    Lint("op_ref", false),
    Lint("option_as_ref_cloned", false),
    ...
    Lint("owned_cow", false),
    Lint("panic", false),
    Lint("panic_in_result_fn", false),
    Lint("panicking_overflow_checks", false),
    ...
    Lint("ptr_eq", false),
    Lint("ptr_offset_by_literal", false),
    Lint("ptr_offset_with_cast", false),
    Lint("pub_underscore_fields", false),
    Lint("pub_use", false),
    ...
    Lint("redundant_iter_cloned", false),
    ...
    Lint("redundant_test_prefix", false),
    Lint("redundant_type_annotations", false),
    Lint("ref_as_ptr", false),
    Lint("ref_binding_to_reference", false),
    Lint("ref_option", false),
    Lint("ref_option_ref", false),
    Lint("ref_patterns", false),
    Lint("regex_creation_in_loops", false),
    Lint("renamed_function_params", false),
    Lint("repeat_once", false),
    Lint("repeat_vec_with_capacity", false),
    Lint("replace_box", false),
    Lint("repr_packed_without_abi", false),
    Lint("reserve_after_initialization", false),
    Lint("rest_pat_in_fully_bound_structs", false),
    Lint("result_filter_map", false),
    Lint("result_large_err", false),
    Lint("result_map_or_into_option", false),
    Lint("result_map_unit_fn", false),
    Lint("result_unit_err", false),
    Lint("return_and_then", false),
    ...
    Lint("self_only_used_in_recursion", false),
    ...
    Lint("set_contains_or_insert", false),
    ...
    Lint("str_split_at_newline", false),
    ...
    Lint("suspicious_open_options", false),
    ...
    Lint("unbuffered_bytes", false),
    Lint("unchecked_time_subtraction", false),
    ...
    Lint("uninhabited_references", false),
    ...
    Lint("volatile_composites", false),
    Lint("waker_clone_wake", false),
    Lint("while_float", false),
