...
class KnownItems(
    ...
    val MetaSized: RsTraitItem? get() = findLangItem("meta_sized")
    val PointeeSized: RsTraitItem? get() = findLangItem("pointee_sized")
    ...
    val AsyncFn: RsTraitItem? get() = findLangItem("async_fn")
    val AsyncFnMut: RsTraitItem? get() = findLangItem("async_fn_mut")
    val AsyncFnOnce: RsTraitItem? get() = findLangItem("async_fn_once")
