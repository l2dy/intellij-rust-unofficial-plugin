...
val RS_RAW_LITERALS = tokenSetOf(RAW_STRING_LITERAL, RAW_BYTE_STRING_LITERAL, RAW_CSTRING_LITERAL)

val RS_BYTE_STRING_LITERALS = tokenSetOf(BYTE_STRING_LITERAL, RAW_BYTE_STRING_LITERAL)

val RS_CSTRING_LITERALS = tokenSetOf(CSTRING_LITERAL, RAW_CSTRING_LITERAL)

val RS_ALL_STRING_LITERALS = tokenSetOf(
    STRING_LITERAL, BYTE_STRING_LITERAL, CSTRING_LITERAL,
    RAW_STRING_LITERAL, RAW_BYTE_STRING_LITERAL, RAW_CSTRING_LITERAL
)

val RS_LITERALS = tokenSetOf(
    STRING_LITERAL, BYTE_STRING_LITERAL, CSTRING_LITERAL,
    RAW_STRING_LITERAL, RAW_BYTE_STRING_LITERAL, RAW_CSTRING_LITERAL,
    CHAR_LITERAL, BYTE_LITERAL, INTEGER_LITERAL, FLOAT_LITERAL, BOOL_LITERAL
)

val RS_CONTEXTUAL_KEYWORDS = tokenSetOf(DEFAULT, UNION, AUTO, DYN, RAW, SAFE)
val RS_EDITION_2018_KEYWORDS = tokenSetOf(ASYNC, TRY)
val RS_EDITION_2024_KEYWORDS = tokenSetOf(GEN)
